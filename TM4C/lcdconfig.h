...
#endif
//lcd D7 pin
#define LCD_PORT_D7     	GPIOC->DATA
#define LCD_DDR_D7      	GPIOC->DIR
#define D7_BIT		        7
//lcd D6 pin
#define LCD_PORT_D6     	GPIOC->DATA
#define LCD_DDR_D6      	GPIOC->DIR
#define D6_BIT				6
//lcd D5 pin
#define LCD_PORT_D5     	GPIOC->DATA
#define LCD_DDR_D5      	GPIOC->DIR
#define D5_BIT				5
//lcd D4 pin
#define LCD_PORT_D4     	GPIOC->DATA
#define LCD_DDR_D4      	GPIOC->DIR
#define D4_BIT				4
//lcd Register Select pin
#define RS_PORT				GPIOA->DATA
#define RS_BIT				2
#define RS_DDR				GPIOA->DIR
//lcd Read/write pin	
#define RW_PORT				GPIOA->DATA
#define RW_BIT				3
#define RW_DDR				GPIOA->DIR
//lcd Enable pin	
#define E_PORT				GPIOA->DATA
#define E_BIT				4
#define E_DDR				GPIOA->DIR
